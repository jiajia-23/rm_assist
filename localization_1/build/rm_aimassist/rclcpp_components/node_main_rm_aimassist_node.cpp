...
#define NODE_MAIN_LOGGER_NAME "rm_aimassist_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_aimassist_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_assist::AssistNode>";
