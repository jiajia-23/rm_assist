...
#define NODE_MAIN_LOGGER_NAME "rm_rune_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_rune.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<qianli_rm_rune::RuneNode>";
