...
#define NODE_MAIN_LOGGER_NAME "closed_loop_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libclosed_loop.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_closed_loop::ClosedLoopNode>";
