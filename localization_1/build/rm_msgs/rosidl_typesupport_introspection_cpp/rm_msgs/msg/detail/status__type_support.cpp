...
{
  new (message_memory) rm_msgs::msg::Status(_init);
}

void Status_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_msgs::msg::Status *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Status_message_member_array[1] = {
  {
    ...
    offsetof(rm_msgs::msg::Status, is_rune),  // bytes offset in struct
...
{
  return &::rm_msgs::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_msgs, msg, Status)() {
  return &::rm_msgs::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
