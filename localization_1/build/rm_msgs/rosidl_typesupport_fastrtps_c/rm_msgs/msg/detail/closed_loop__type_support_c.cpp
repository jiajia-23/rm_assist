...
#include "rm_msgs/msg/detail/closed_loop__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // now_armor_pose, now_pose, pred_pose
#include "rosidl_runtime_c/string.h"  // id
#include "rosidl_runtime_c/string_functions.h"  // id
#include "std_msgs/msg/detail/header__functions.h"  // image_header, shoot_header
...
using _ClosedLoop__ros_msg_type = rm_msgs__msg__ClosedLoop;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ClosedLoop__ros_msg_type * ros_message = static_cast<const _ClosedLoop__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: now_pose
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->now_pose, cdr))
    {
      return false;
    }
  }

  // Field name: pred_pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->pred_pose, cdr))
    {
      return false;
    }
  }

  // Field name: now_armor_pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->now_armor_pose, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _ClosedLoop__ros_msg_type * ros_message = static_cast<_ClosedLoop__ros_msg_type *>(untyped_ros_message);
  // Field name: image_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ClosedLoop__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_msgs__msg__ClosedLoop(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_msgs__msg__ClosedLoop;
    is_plain =
      (
...
static size_t _ClosedLoop__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_msgs__msg__ClosedLoop(
...
static message_type_support_callbacks_t __callbacks_ClosedLoop = {
  "rm_msgs::msg",
  "ClosedLoop",
