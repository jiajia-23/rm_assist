...
#include "rm_msgs/msg/detail/receive_serial__rosidl_typesupport_fastrtps_c.h"
...
using _ReceiveSerial__ros_msg_type = rm_msgs__msg__ReceiveSerial;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: serial_time
  {
    cdr << ros_message->serial_time;
  }
...
size_t get_serialized_size_rm_msgs__msg__ReceiveSerial(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ReceiveSerial__ros_msg_type * ros_message = static_cast<const _ReceiveSerial__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name serial_time
  {
    size_t item_size = sizeof(ros_message->serial_time);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name is_rune
...
static uint32_t _ReceiveSerial__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_msgs__msg__ReceiveSerial(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_msgs
size_t max_serialized_size_rm_msgs__msg__ReceiveSerial(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_msgs__msg__ReceiveSerial;
    is_plain =
      (
...
static size_t _ReceiveSerial__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_msgs__msg__ReceiveSerial(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_msgs, msg, ReceiveSerial)() {
