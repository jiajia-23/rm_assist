...
bool rm_msgs__msg__armor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_msgs.msg._armor.Armor", full_classname_dest, 24) == 0);
  }
  rm_msgs__msg__Armor * ros_message = _ros_message;
  {  // header
  ...
  {  // color
    ...
    assert(PyLong_Check(field));
    ros_message->color = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // name
...
PyObject * rm_msgs__msg__armor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_msgs.msg._armor");
