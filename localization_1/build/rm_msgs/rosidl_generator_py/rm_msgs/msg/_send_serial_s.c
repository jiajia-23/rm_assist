...
bool rm_msgs__msg__send_serial__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_msgs.msg._send_serial.SendSerial", full_classname_dest, 35) == 0);
  }
  rm_msgs__msg__SendSerial * ros_message = _ros_message;
  {  // header
...
PyObject * rm_msgs__msg__send_serial__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_msgs.msg._send_serial");
