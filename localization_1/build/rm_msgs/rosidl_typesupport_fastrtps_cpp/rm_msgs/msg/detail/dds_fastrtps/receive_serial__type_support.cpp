...
#include "rm_msgs/msg/detail/receive_serial__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_msgs::msg::ReceiveSerial & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_msgs::msg::ReceiveSerial & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_msgs::msg::ReceiveSerial;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_msgs::msg::ReceiveSerial *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_msgs::msg::ReceiveSerial *>(
    untyped_ros_message);
...
get_message_type_support_handle<rm_msgs::msg::ReceiveSerial>()
{
  return &rm_msgs::msg::typesupport_fastrtps_cpp::_ReceiveSerial__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_msgs, msg, ReceiveSerial)() {
  return &rm_msgs::msg::typesupport_fastrtps_cpp::_ReceiveSerial__handle;
}
