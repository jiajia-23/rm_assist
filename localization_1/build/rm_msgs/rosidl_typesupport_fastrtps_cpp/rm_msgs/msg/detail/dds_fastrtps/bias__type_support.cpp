...
#include "rm_msgs/msg/detail/bias__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_msgs::msg::Bias;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_msgs::msg::Bias *>(
    untyped_ros_message);
...
{
  return &rm_msgs::msg::typesupport_fastrtps_cpp::_Bias__handle;
}
