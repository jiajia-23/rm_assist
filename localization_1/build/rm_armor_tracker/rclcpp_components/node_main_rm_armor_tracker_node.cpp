...
#define NODE_MAIN_LOGGER_NAME "rm_armor_tracker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_armor_tracker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_armor_tracker::ArmorTrackerNode>";
