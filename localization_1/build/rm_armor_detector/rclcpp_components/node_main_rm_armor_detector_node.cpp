...
#define NODE_MAIN_LOGGER_NAME "rm_armor_detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_armor_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_armor_detector::ArmorDetectorNode>";
