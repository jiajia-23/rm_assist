...
#define NODE_MAIN_LOGGER_NAME "icp_registration_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libicp_registration.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<icp::IcpNode>";
